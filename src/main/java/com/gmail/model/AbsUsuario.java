...
public abstract class AbsUsuario implements Cloneable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AbsUsuario)) return false;
        AbsUsuario that = (AbsUsuario) o;
        return idUsuario == that.idUsuario && Objects.equals(nombre, that.nombre) && Objects.equals(apellido, that.apellido) && Objects.equals(correo, that.correo) && Objects.equals(contrasenia, that.contrasenia) && Objects.equals(telefono, that.telefono) && Objects.equals(sexo, that.sexo) && Objects.equals(fechaNacimiento, that.fechaNacimiento);
    }

    @Override
    public int hashCode() {
        return Objects.hash(idUsuario, nombre, apellido, correo, contrasenia, telefono, sexo, fechaNacimiento);
    }
